...
def banner():
    ...
    print(G + banner + W + '\n')
	print(G + '[>] ' + R + 'Created by : ' + W + 'JoseGOD)
...
def trendeatila():
	...
	qlist = []
	total_url = []
	paste_sites = ['cl1p.net', 'dpaste', 'dumpz.org', 'hastebin', 'facebook', '.onion', 'ideone', 'pastebin', 'pw.fabian-fingerle.de','gist.github.com','https://www.heypasteit.com/','ivpaste.com','mysticpaste.com','paste.org.ru','paste2.org','sebsauvage.net/paste/','slexy.org','squadedit.com','wklej.se','textsnip.com']
